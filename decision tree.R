#Decision Tree
# # Finding how people take decisons to buy products
#Creating Desicion Tree

library(rpart)  #for decison trees CART
...
predict(dtree1, newdata = data.frame(gender='Female'))
# prob
predict(dtree1, newdata = data.frame(gender='Female'), type=c('class'))  # class - buy or not 
predict(dtree1, newdata = data.frame(gender=c('Male','Female','Male','Male')), type='class')  # for 3 values
